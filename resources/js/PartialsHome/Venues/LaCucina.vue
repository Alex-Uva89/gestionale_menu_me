...
<div class="section_accordion relative h-full" >
  ...
  <section class="flex justify-center mobile">
    ...
    <div class="container-food">
      <form class="grid grid-cols-5" @submit.prevent="createCategory(1)">
      ...
      <Category
        ...
        :dish_category="dish_laCucina_category"
        :addDishes="addDishes"
    ...
    <div class="container-beverage">
      <form class="grid grid-cols-5" @submit.prevent="createCategoryDrink(1)">
        ...
        <CategoryDrink
          ...
          :editCategory="editCategory"
          :updateIsShowStatus="updateIsShowStatus"
          :drink_category="drink_laCucina_category"
          :addDishes="addDishes"
          :showAddDishesModal="showAddDishesModal"
          :componentKey="componentKey"
...
export default {
    ...
    methods: {
        ...
        createCategory(venue_ids) {
          ...
          .then(response => {
              ...
              this.localCategory_laCucina.push(response.data);
    ...
    watch: {
        category_laCucina(newVal) {
            this.localCategory_laCucina = newVal;
        },
        dish_laCucina_category(newVal) {
            this.dish_laCucina_category = newVal;
        },
    },
    created() {
        this.componentKey = 0; 
