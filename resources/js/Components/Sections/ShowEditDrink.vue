<template>
    ...
    <div class="container-drink-show" :key="localComponentAllergen">
        ...
        <div class="grid-show-drink">
            ...
            <div class="h-fit  p-2 border-2 border-black flex items-center justify-between" style="grid-area: url;">
                <div class="flex gap-2">
                    <div class="font-black uppercase">
            ...
            <div class="h-fit px-1  py-2 border-2 border-black flex items-center justify-between"
        ...
        <div v-if="showModalTraductionDescription" class="z-50">
            <ModalAction :showModal="showModalTraductionDescription" :selectedDrink="selectedDrink">
                ...
                <input type="text" id="instructions_en" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.instructions_en" :placeholder="copySelectedDish.instructions_en">

                <label for="instructions_fr" class="font-bold text-xl">Francese:</label>
                <input type="text" id="instructions_fr" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.instructions_fr" :placeholder="copySelectedDish.instructions_fr">
                    ...
                    <ul class="flex gap-2">
                        <template v-for="drink in pairings">
                            <template v-for="drink in drink.drinks">
                                <li class="px-4 py-1 border border-3 border-black rounded-full"
                                    v-if="drink.id === selectedDrink.id">
                                    {{ drink.name }}
                                </li>
                            </template>
                        </template>
        ...
        <div v-if="showModalTraductionColor" class="z-50">
            <ModalAction :showModal="showModalTraductionColor" :selectedDrink="selectedDrink">
                ...
                <input type="text" id="color_en" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.color_en">

                <label for="color_fr" class="font-bold text-xl">Francese:</label>
                <input type="text" id="color_fr" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.color_fr">
        ...
        <div v-if="showModalTraductionFlavour" class="z-50">
            <ModalAction :showModal="showModalTraductionFlavour" :selectedDrink="selectedDrink">
                ...
                <input type="text" id="flavour_en" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.flavour_en">

                <label for="flavour_fr" class="font-bold text-xl">Francese:</label>
                <input type="text" id="flavour_fr" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.flavour_fr">
        ...
        <div v-if="showModalTraductionOrigin" class="z-50">
            <ModalAction :showModal="showModalTraductionOrigin" :selectedDrink="selectedDrink">
                ...
                <input type="text" id="origin_en" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.origin_en">

                <label for="origin_fr" class="font-bold text-xl">Francese:</label>
                <input type="text" id="origin_fr" class="w-full border-1 border-black rounded"
                    v-model="copySelectedDish.origin_fr">
        ...
        <div v-if="showModalEditNose" class="z-50">
            <ModalAction :showModal="showModalEditNose" :selectedDrink="selectedDrink">
                ...
                <input type="text" class="w-full border-1 border-black rounded" v-model="copySelectedDish.nose">
        ...
        <div v-if="showModalURL" class="z-50">
            <ModalAction :showModal="showModalURL" :selectedDrink="selectedDrink">
                <h2 class="font-bold text-2xl text-center pb-6">
                    Inserisci il link a drinkPuglia:
                </h2>
                ...
                <label for="url" class="font-bold text-xl">Link:</label>
                <input type="text" id="url" class="w-full border-1 border-black rounded" v-model="copySelectedDish.url">



                <div class="flex w-full justify-between py-5">
                    <button class="bg-red-600 border-black border-2 rounded text-white p-3 w-32"
                        @click="confirmEditURL(copySelectedDish)">Conferma</button>
                    <button class="bg-white border-black border-2 rounded text-black p-3 w-32"
                        @click="showModalURL = false">Annulla</button>
                </div>
            </ModalAction>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        confirmEditURL(dishNew) {
            this.selectedDrink.url = dishNew.url
